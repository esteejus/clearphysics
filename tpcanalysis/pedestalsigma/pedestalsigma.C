{
  ...
  STCore *c = new STCore("/cache/scr/spirit/narval/merged/run_0334.dat");
  c -> SetAGETMap("/cache/scr/spirit//justin/clearphysics/tpcanalysis/asad_get_maps/06_07_2015_cosmic/AGET.map");
  c -> SetUAMap("/cache/scr/spirit/justin/clearphysics/tpcanalysis/asad_get_maps/06_07_2015_cosmic/UnitAsAd.map");
  c -> SetFPNPedestal();
  c -> SetData(0);
